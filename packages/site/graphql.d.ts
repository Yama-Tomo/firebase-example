...
export type ArticlesConnection = {
  ...
  group: Array<ArticlesGroupConnection>;
};


export type ArticlesConnectionDistinctArgs = {
  field: ArticlesFieldsEnum;
};


export type ArticlesConnectionGroupArgs = {
  skip?: Maybe<Scalars['Int']>;
  limit?: Maybe<Scalars['Int']>;
  field: ArticlesFieldsEnum;
};

export type ArticlesCreated_At = {
  sec?: Maybe<Scalars['Int']>;
  nanoSec?: Maybe<Scalars['Int']>;
};

export type ArticlesCreated_AtFilterInput = {
  sec?: Maybe<IntQueryOperatorInput>;
  nanoSec?: Maybe<IntQueryOperatorInput>;
};

export type ArticlesEdge = {
  next?: Maybe<Articles>;
  node: Articles;
  previous?: Maybe<Articles>;
};

export type ArticlesFieldsEnum = 
  'id' |
  'parent___id' |
...
export type ArticlesSortInput = {
  fields?: Maybe<Array<Maybe<ArticlesFieldsEnum>>>;
  order?: Maybe<Array<Maybe<SortOrderEnum>>>;
};

export type ArticlesUpdated_At = {
  sec?: Maybe<Scalars['Int']>;
  nanoSec?: Maybe<Scalars['Int']>;
};

export type ArticlesUpdated_AtFilterInput = {
  sec?: Maybe<IntQueryOperatorInput>;
  nanoSec?: Maybe<IntQueryOperatorInput>;
};
...
export type InformationConnection = {
  ...
  nodes: Array<Information>;
  pageInfo: PageInfo;
  distinct: Array<Scalars['String']>;
  group: Array<InformationGroupConnection>;
};


export type InformationConnectionDistinctArgs = {
  field: InformationFieldsEnum;
};


export type InformationConnectionGroupArgs = {
  skip?: Maybe<Scalars['Int']>;
  limit?: Maybe<Scalars['Int']>;
  field: InformationFieldsEnum;
};

export type InformationCreated_At = {
  sec?: Maybe<Scalars['Int']>;
  nanoSec?: Maybe<Scalars['Int']>;
};

export type InformationCreated_AtFilterInput = {
  sec?: Maybe<IntQueryOperatorInput>;
  nanoSec?: Maybe<IntQueryOperatorInput>;
};

export type InformationEdge = {
  next?: Maybe<Information>;
  node: Information;
  previous?: Maybe<Information>;
};

export type InformationFieldsEnum = 
  'id' |
  'parent___id' |
  'parent___parent___id' |
  'parent___parent___parent___id' |
...
export type InformationSortInput = {
  fields?: Maybe<Array<Maybe<InformationFieldsEnum>>>;
  order?: Maybe<Array<Maybe<SortOrderEnum>>>;
};
...
export type SeoQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'description' | 'siteUrl' | 'title'>> }> };

export type SearchResultThumbnailsQueryVariables = {};


export type SearchResultThumbnailsQuery = { allFile: { nodes: Array<{ fields?: Maybe<Pick<FileFields, 'articleId'>>, childImageSharp?: Maybe<{ fixed?: Maybe<GatsbyImageSharpFixed_NoBase64Fragment> }> }> } };

export type AllInformationQueryVariables = {};


export type AllInformationQuery = { allInformation: { edges: Array<{ node: (
        Pick<Information, 'id' | 'text'>
